...
- ⏱️ Загальний час: ~8-12 хвилин

#### Невдалий пайплайн (Bad код)
...
- ⏹️ deploy: Skipped
- ⏹️ dast: Skipped
- ⏱️ Час до виявлення проблеми: ~2-3 хвилини

#### Деталі помилки тесту
![Деталі помилки тесту](screenshot_3_test_error_details.png)
*Лог помилки показує невідповідність в assertion тесту: очікувалось "Hello, World!", але тест перевіряв "Hello, Evil World!"*
